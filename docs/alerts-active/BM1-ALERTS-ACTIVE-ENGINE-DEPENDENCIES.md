...
**Later status (hygiene 23 September 2026 — cross-link only, deps text below unchanged):** S29 engine **stay-locked** [PR #64](https://github.com/Artemis2028/BM1-bakeoff/pull/64) @ `ce177f0`. `ALERTS_ACTIVE_LOCKED_FROM_REMASTERED` stays false. **No Referee Pass claimed.**  
