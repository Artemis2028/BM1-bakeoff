...
The 21 September 2026 hygiene pass aligns §2 / §16 with `main` @ `74f574b` (after dockClear engine PR #61). The 23 September 2026 pass continues that alignment through `main` @ `cb9be75` (after roster engine PR #68). The 24 September 2026 Bajoran Solar Sailor brief continues from `main` @ `e92db62` (after hygiene #69). The 25 September 2026 pass records S32 engine #71 on `main` @ `557200f`, records briefing brief #72 @ `37bca25`, records S33 engine #73 on `main` @ `0534015`, and records the world cargo delivery brief **merged** #74 @ `a76acbf` with the S34 engine **in review**. It does not replace this plan, does not mark Warp Core or the other leftovers done, does not claim a Referee Pass, and does not reopen Phase 1–10 / EW / boarding / utility / ledger / empty-armable / construction / HTML / economy / standing / dockClear / alertsActive / away-team XP / roster-catalog / hygiene / sailor / briefing gates (#33–#73).

## 16. Convergence backlog (from guided remastered-work roadmap)

Added: 12 September 2026. Hygiene: 21 September 2026 vs `main` @ `74f574b`; continued 23 September 2026 vs `main` @ `cb9be75`; Sail reclass 24 September 2026 vs `main` @ `e92db62`; S32 engine 25 September 2026 vs `main` @ `557200f`; S33 engine #73 is on `main` @ `0534015`. Current `main` is the S34 world cargo brief #74 @ `a76acbf`. **Docs only** for this plan file. Detail, Flash weapon table, boarding rules, and standing numbers live in [`docs/GUIDED-CONVERGENCE.md`](GUIDED-CONVERGENCE.md). Bajoran Solar Sailor: [`docs/bajoran-solar-sailor/`](bajoran-solar-sailor/BM1-BAJORAN-SOLAR-SAILOR-PROPOSAL.md) (S32 engine #71 stay-locked @ `557200f`). Captains briefing archive brief **merged** #72; S33 engine **merged** #73: [`docs/briefing-archive/`](briefing-archive/BM1-BRIEFING-ARCHIVE-PROPOSAL.md). World cargo delivery brief **merged** #74; S34 engine **in review**: [`docs/world-cargo-delivery/`](world-cargo-delivery/BM1-WORLD-CARGO-DELIVERY-PROPOSAL.md). **No Referee Pass claimed.**

**Dual-track:** guided `BM1-remastered-work` may have numbered catalog wire and economy/standing differently. Bake-off already has Phase 1–10 Dominion-first engine, the side-lane, additive `bm-ships/` **and catalog wire (PR #28)**, EW 9–9.4, boarding, flags/utility, ledger, empty-armable, construction, HTML catalogs, economy/difficulty, standing-tiers, dockClear S28, alertsActive S29 (#63/#64), away-team XP S30 (#65/#66), the Phase 10 roster catalog S31 (#67/#68), and Bajoran Solar Sailor S32 (#70/#71 @ `557200f`). Current `main` is the S34 world cargo brief #74 @ `a76acbf`. Do not crib guided engine code. The S34 `worldCargoDelivery` engine is **in review** and is not a second implementation of those packages. **No Referee Pass claimed.**
...
Rows below are **locked** on `main` @ `a76acbf` (through S32 engine #71 @ `557200f`, briefing brief #72, S33 engine #73, and world cargo brief #74). They are **not** Agreed next. Do not reopen closed gates. #33–#74 stay locked. The S34 engine is **in review**, not a row in this locked table. **No Referee Pass claimed.**
...
| 13 | Captains briefing / jump-intel archive | **Engine landed** (`docs/briefing-archive/`; PR #72 brief @ `37bca25` / PR #73 engine @ `0534015`). **Stay locked.** | **Locked** | Knowledge-only. Cap 24 × 12. `BRIEFING_ARCHIVE_LOCKED_FROM_REMASTERED` stays false. World cargo delivery is **in review** and does **not** reopen this lane. |
...
- World cargo delivery brief is **merged** [PR #74](https://github.com/Artemis2028/BM1-bakeoff/pull/74) @ `a76acbf` under [`docs/world-cargo-delivery/`](world-cargo-delivery/BM1-WORLD-CARGO-DELIVERY-PROPOSAL.md) (package `worldCargoDelivery`, slice S34). The S34 engine is **in review**. Nine hard gates: a cloaked drop never earns a legal payout; a failed cloaked drop of an open contract leaves the pods aboard; patrol suspicion is not a weapons grant; deliver-once holds across reload and re-dock; old saves have no deliveries pending. Not a Referee Pass. Does not reopen #33–#74. `WORLD_CARGO_LOCKED_FROM_REMASTERED` stays false.
