...
Rows below are **locked** on `main` @ `37bca25` (through S32 engine #71 @ `557200f` and briefing brief #72). They are **not** Agreed next. Do not reopen closed gates. #33–#72 stay locked. The S33 briefing archive engine is **in review**, not a row in this locked table. **No Referee Pass claimed.**
...
- Do not reopen Phase 1–6 briefs, the side-lane, EW, boarding, Phase 10, flags/utility, ledger, empty-armable, construction, HTML, economy, standing, dockClear, alertsActive, away-team XP, the roster catalog, or the sailor catalog as incomplete. **#33–#71 stay locked.**
...
- Captains briefing / jump-intel archive brief is **merged** [PR #72](https://github.com/Artemis2028/BM1-bakeoff/pull/72) @ `37bca25` (opened from `main` @ `557200f`). S33 `briefingArchive` engine is **in review**, not merged. Not a Referee Pass. #33–#72 stay locked. S32 stays @ `557200f`. `BRIEFING_ARCHIVE_LOCKED_FROM_REMASTERED` stays false.
