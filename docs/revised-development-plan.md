...
| 4 | Boarding / capture / command transfer | **Brief open** (`docs/boarding/`); engine not implemented. Explicitly deferred in P4–P9.2 | **Agreed next** | ≤10% hull to board; capture XOR scuttle; away-team XP **not tracked yet** (magnitudes TBD); fleet command transfer. See `GUIDED-CONVERGENCE.md` §4 and `docs/boarding/`. **Not** Phase 10. |
