...
The 21 September 2026 hygiene pass aligns §2 / §16 with `main` @ `74f574b` (after dockClear engine PR #61). The 23 September 2026 pass continues that alignment through `main` @ `cb9be75` (after roster engine PR #68). The 24 September 2026 Bajoran Solar Sailor brief continues from `main` @ `e92db62` (after hygiene #69). The 25 September 2026 pass records S32 engine #71 on `main` @ `557200f` and opens the captains briefing / jump-intel archive brief **in review**. It does not replace this plan, does not mark Warp Core or the other leftovers done, does not claim a Referee Pass, and does not reopen Phase 1–10 / EW / boarding / utility / ledger / empty-armable / construction / HTML / economy / standing / dockClear / alertsActive / away-team XP / roster-catalog / hygiene / sailor gates (#33–#71).

## 16. Convergence backlog (from guided remastered-work roadmap)

Added: 12 September 2026. Hygiene: 21 September 2026 vs `main` @ `74f574b`; continued 23 September 2026 vs `main` @ `cb9be75`; Sail reclass 24 September 2026 vs `main` @ `e92db62`; S32 engine + briefing-archive brief 25 September 2026 vs `main` @ `557200f`. **Docs only.** Detail, Flash weapon table, boarding rules, and standing numbers live in [`docs/GUIDED-CONVERGENCE.md`](GUIDED-CONVERGENCE.md). Bajoran Solar Sailor: [`docs/bajoran-solar-sailor/`](bajoran-solar-sailor/BM1-BAJORAN-SOLAR-SAILOR-PROPOSAL.md) (S32 engine #71 stay-locked). Captains briefing archive (**in review**): [`docs/briefing-archive/`](briefing-archive/BM1-BRIEFING-ARCHIVE-PROPOSAL.md).

**Dual-track:** guided `BM1-remastered-work` may have numbered catalog wire and economy/standing differently. Bake-off already has Phase 1–10 Dominion-first engine, the side-lane, additive `bm-ships/` **and catalog wire (PR #28)**, EW 9–9.4, boarding, flags/utility, ledger, empty-armable, construction, HTML catalogs, economy/difficulty, standing-tiers, dockClear S28, alertsActive S29 (#63/#64), away-team XP S30 (#65/#66), the Phase 10 roster catalog S31 (#67/#68), and Bajoran Solar Sailor S32 (#70/#71 @ `557200f`). Do not crib guided engine code. The captains briefing archive is **in review** (docs only) and is not a second implementation of those packages.
...
Rows below are **locked** on `main` @ `557200f` (through S32 engine #71). They are **not** Agreed next. Do not reopen closed gates. #33–#71 stay locked. The captains briefing archive is **in review**, not a row in this locked table.
...
- Captains briefing / jump-intel archive (`briefingArchive`) is **in review** under `docs/briefing-archive/` from `main` @ `557200f`. Docs only. S33 is a later sketch. Not Agreed-next engine. Not a Referee Pass. #33–#71 stay locked. `BRIEFING_ARCHIVE_LOCKED_FROM_REMASTERED` stays false.
