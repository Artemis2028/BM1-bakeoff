...
Updated: 23 September 2026 (hygiene vs `main` @ `cb9be75` after Phase 10 roster engine PR #68, tip `3ecadd3`; prior hygiene 21 September 2026 vs `74f574b` after dockClear engine PR #61).  
Checkpoint: Phase 1–10 Dominion-first, side-lane, catalog wire, EW 9–9.4, boarding, flags/utility, ledger, empty-armable, construction, HTML catalogs, economy/difficulty, standing-tiers, dockClear S28, alertsActive S29 (#63/#64), away-team XP S30 (#65/#66), and the Phase 10 roster catalog S31 (#67/#68) are on bake-off `main`. Phase 6 sensors/cloak engine landed [PR #24](https://github.com/Artemis2028/BM1-bakeoff/pull/24) @ `749393b`. **No Referee Pass claimed** on the post-Phase-4 packages. Product knowledge lives in **§16** and `docs/GUIDED-CONVERGENCE.md`. Do not treat Passed Phase 1–6 briefs, the side-lane, or later locked engines as incomplete.

This is the current roadmap for what we have completed, what we need to add, and what we would like to build later. It carries forward the cloud handoff and faction-doctrine work, with the decisions made during the Phase 1 and Phase 2 reviews taking precedence. The later milestones were proposed implementation slices, not approval to implement every idea at once. Sections 3–15 retain the original design text; **§16 is the bake-off-relative status** and takes precedence when older “Pending / next / Agreed next” lines disagree with landed Passes. Hygiene 21 September 2026 flipped the §2 holding-zones **Pending** row and the §16.2 Phase 10 / catalog-not-wired claims. Hygiene 23 September 2026 marks alertsActive, away-team XP, and the Phase 10 full-roster catalog **closed / stay-locked** (#63–#68).
...
The 21 September 2026 hygiene pass aligns §2 / §16 with `main` @ `74f574b` (after dockClear engine PR #61). The 23 September 2026 pass continues that alignment through `main` @ `cb9be75` (after roster engine PR #68). Those passes do not replace this plan, do not mark unfinished bake-off leftovers done, do not claim a Referee Pass, and do not reopen Phase 1–10 / EW / boarding / utility / ledger / empty-armable / construction / HTML / economy / standing / dockClear / alertsActive / away-team XP / roster-catalog gates (#33–#68).

## 16. Convergence backlog (from guided remastered-work roadmap)

Added: 12 September 2026. Hygiene: 21 September 2026 vs `main` @ `74f574b`; continued 23 September 2026 vs `main` @ `cb9be75`. **Docs only.** Detail, Flash weapon table, boarding rules, and standing numbers live in [`docs/GUIDED-CONVERGENCE.md`](GUIDED-CONVERGENCE.md).
...
- Leftovers stay explicit and are **not** Agreed-next packages: magnitudes / discovery % / invasion odds injectable; flags capacity / activation TBD (#46/#47); Bajoran Sail / Warp Core deferred utilities; `protect-all` ROE hold (do not invent a third ROE); Thaleron facility unverified; Flash prices not live locks; boarding success-odds tables injectable.
