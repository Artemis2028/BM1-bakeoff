...
| `docs/phase6/` | Phase 6 sensors / cloak / contact uncertainty / purposeful system space proposal + engine deps — brief merged (PR #22); engine implemented from that brief; **no Referee Pass claimed** |
