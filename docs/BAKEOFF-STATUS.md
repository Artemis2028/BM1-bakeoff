...
Updated: `2026-09-13T19:20:00Z` (Phase 8 economy brief on `cursor/phase8-economy-brief-e6cd`)  
Head: docs-only Phase 8 proposal from `main` @ `ca2645d` (catalog wire PR #28 + Phase 7 engine PR #29). **No Referee Pass claimed.**
...
| `docs/phase8/` | Phase 8 economy / trade permissions / progression proposal + engine deps — brief open; finite markets, price≠ban, money≠standing≠Reman, anti-farm, conquest costs; cites catalog wire + standing (PR #28) without reopening; **no Referee Pass claimed** |
| `docs/GUIDED-CONVERGENCE.md` | Guided remastered-work product knowledge for remaining packages (weapons table, boarding, standing, catalog wire). Standing tiers + catalog wire are **engine-landed** (PR #28); this file remains source notes. Companion: plan §16 |
