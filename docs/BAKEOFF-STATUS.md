...
6. Side-lane brief (repairCapable / Reman unlock / independence-civil-war) — **proposal [PR #16](https://github.com/Artemis2028/BM1-bakeoff/pull/16) open** from `main` @ `10c3a7e` (after additive `bm-ships/` PR #15; no catalog wire). **Not** roadmap Phase 5. **No Referee Pass claimed.** Referee / One / Four / Two score the three hard gates before any engine PR. Number Three probes only after engine.
