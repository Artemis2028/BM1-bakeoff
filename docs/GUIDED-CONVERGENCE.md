...
**Scoreable brief stay-locked (PR #58 @ `02cf587`).** S27 subscribe module **engine on this tip** under [`docs/standing-tiers/`](standing-tiers/) and `src/standing-tiers.js`. Money is not trust. **No Referee Pass claimed.** **Keep #58 locked.** Do not reopen the wire, Reman, or economy / difficulty overlays.
...
4. **Standing tiers** as a named gate surface (Open → Excalibur; new-character 20; Independent trade standing in neutral entry) — **brief #58 stay-locked**; S27 engine on this tip under `docs/standing-tiers/` + `src/standing-tiers.js`. Helpers already landed (PR #28). Economy §8 / #56 / #57 **stay-locked**.
