...
## 8. Broader economy / difficulty — Proposed (scoreable brief open)
...
9. **Broader economy / difficulty knobs** (plan §8 / §10), preserving political identity — scoreable brief now under `docs/economy-difficulty/`.
