...
This file holds the detailed weapons table, boarding rules, standing tiers, and catalog/purchase notes. The development plan keeps the short **locked-package** list and pointers (§16.2). Rows that used to say “Agreed next” are **engine-landed / stay locked** on `main` @ `a76acbf`. alertsActive (#63/#64), away-team XP (#65/#66), the Phase 10 full-roster catalog (#67/#68), Bajoran Solar Sailor S32 (#70/#71 @ `557200f`), and the captains briefing archive (#72 @ `37bca25` / #73 @ `0534015`) are **closed / stay-locked**. Flash “Bajoran Sail” is a **ship** (`docs/bajoran-solar-sailor/`), not a deferred-utility leftover. World cargo delivery (`docs/world-cargo-delivery/`) is **in review**. Named leftovers are not Agreed next. Warp Core stays deferred. **No Referee Pass claimed.**
